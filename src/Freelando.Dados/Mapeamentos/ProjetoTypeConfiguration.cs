...
internal class ProjetoTypeConfiguration : IEntityTypeConfiguration<Projeto>
{
    public void Configure(EntityTypeBuilder<Projeto> entity)
    {
        ...
        {
            vigencia.Property(e => e.DataInicio).HasColumnName("DataInicio").HasConversion(dateTimeToDateConverter);
            vigencia.Property(e => e.DataEncerramento).HasColumnName("DataEncerramento").HasConversion(dateTimeToDateConverter);
        });
